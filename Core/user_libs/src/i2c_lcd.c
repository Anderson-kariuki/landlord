...
static void lcd16x2_i2c_sendCommand(uint8_t command)
{
  ...
  if(backlight){
	  ...
	  uint8_t i2cData[4] =
		{
		    command_4_7 | LCD_EN | LCD_NO_BK_LIGHT,
			command_4_7 | LCD_NO_BK_LIGHT,
			command_0_3 | LCD_EN | LCD_NO_BK_LIGHT,
...
static void lcd16x2_i2c_sendData(uint8_t data)
{
  ...
  if(backlight){
	  ...
	  HAL_I2C_Master_Transmit(lcd16x2_i2cHandle, LCD_I2C_SLAVE_ADDRESS, i2cData, 4, 200);
    	...
    	uint8_t i2cData[4] =
	    {
		  data_4_7 | LCD_EN | LCD_NO_BK_LIGHT | LCD_RS,
		  data_4_7 | LCD_NO_BK_LIGHT | LCD_RS,
		  data_0_3 | LCD_EN | LCD_NO_BK_LIGHT | LCD_RS,
		  data_0_3 | LCD_NO_BK_LIGHT | LCD_RS,
	    };
